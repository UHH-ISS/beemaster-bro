...
class rocksdb_backend(backend):
    __swig_setmethods__ = {}
    for _s in [backend]:
        __swig_setmethods__.update(getattr(_s, '__swig_setmethods__', {}))
    __setattr__ = lambda self, name, value: _swig_setattr(self, rocksdb_backend, name, value)
    __swig_getmethods__ = {}
    for _s in [backend]:
        __swig_getmethods__.update(getattr(_s, '__swig_getmethods__', {}))
    __getattr__ = lambda self, name: _swig_getattr(self, rocksdb_backend, name)
    __repr__ = _swig_repr
    __swig_destroy__ = _pybroker.delete_rocksdb_backend
    __del__ = lambda self: None

    def __init__(self, *args):
        this = _pybroker.new_rocksdb_backend(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    def open(self, db_path):
        return _pybroker.rocksdb_backend_open(self, db_path)
rocksdb_backend_swigregister = _pybroker.rocksdb_backend_swigregister
rocksdb_backend_swigregister(rocksdb_backend)
